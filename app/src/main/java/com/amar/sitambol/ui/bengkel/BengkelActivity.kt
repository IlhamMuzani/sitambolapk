...
class BengkelActivity : AppCompatActivity(), BengkelContract.View{

    lateinit var presenter: BengkelPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = BengkelPresenter(this)
    }

    override fun onStart() {
        super.onStart()
        presenter.bengkelList(Constant.KELURAHAN_ID)
    }

    @SuppressLint("SetTextI18n")
    override fun initActivity() {
        tv_title.text = "Pilih Bengkel"
